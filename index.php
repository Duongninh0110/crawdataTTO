...
<?php
    ...
    // $con = mysqli_connect('us-cdbr-iron-east-03.cleardb.net', 'b23b9d40418bb9', '5c91575a', 'heroku_f67ba110b6b1785');
...
', '', $html);
        ...
        // echo $html;
        preg_match_all('#<div class="content fck" id="main-detail-body">(.*)</div>#', $html, $save);
        print_r ($save);
        $data = $value;
